<template>
  <div class="schLib">
    <el-header style="height: 50px; width: 80%; margin-left: auto; margin-right: auto;">
      <el-row style="padding: 5px;justify-content: flex-end " type="flex">
          <span>
            <el-button round> <i class="el-icon-time"/> 浏览记录 </el-button>
          </span>
        <span style="padding-left: 5px">
            <el-button round><i class="el-icon-collection"/> 个人图书馆 </el-button>
          </span>
      </el-row>
    </el-header>
